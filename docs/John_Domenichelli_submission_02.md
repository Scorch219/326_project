I contributed by editing the init.py file for our project. This included dtermining the correct types of Faker data to inject into specific model fields, and populating
